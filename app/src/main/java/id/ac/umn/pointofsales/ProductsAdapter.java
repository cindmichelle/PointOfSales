...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.ProductHolder> implements Serializable{

    private Context context;
    private ArrayList<Product> products;
    private ArrayList<Product> qty = new ArrayList<>();

    private FragmentCommunication mCommunicator;
    Product product;

    public interface FragmentCommunication{
        void onButtonClicked(String id, String name, int price, int plusMinus, int position);
    }
    ...
    public class ProductHolder extends RecyclerView.ViewHolder{
        ...
        public ProductHolder(View itemView, FragmentCommunication Communicator) {
            ...
            btnPlus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    txtQty.setText(String.format(Locale.US, "%,d", (products.get(position).getQty() + 1)));
                    mCommunication.onButtonClicked(products.get(position).getId(), products.get(position).getName(), products.get(position).getPrice(), 1, position);
                }
            });
            ...
            btnMinus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mCommunication.onButtonClicked(products.get(position).getId(), products.get(position).getName(), products.get(position).getPrice(), 0, position);
                }
            });
        }
        ...
        public void setDetails(Product product){
            ...
            txtQty.setText(String.format(Locale.US,"%,d", product.getQty()));
